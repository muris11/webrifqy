...
<a class="nav-link active" href="#revenue-chart" data-
toggle="tab">Area</a>

</li>
<li class="nav-item">

<a class="nav-link" href="#sales-chart" data-
toggle="tab">Donut</a>
...
<canvas id="revenue-chart-canvas" height="300" style="height:

300px;"></canvas>
</div>
<div class="chart tab-pane" id="sales-chart" style="position:

relative; height: 300px;">

<canvas id="sales-chart-canvas" height="300" style="height:
...
<button type="button" class="btn btn-tool" title="Contacts" data-
widget="chat-pane-toggle">
...
<div class="direct-chat-msg right">
    ...
    <li>
    <a href="#">
    <img class="contacts-list-img" src="dist/img/user1-
    
    128x128.jpg" alt="User Avatar">
    ...
    <li>
        <a href="#">
            <img class="contacts-list-img" src="dist/img/user7-
            ...
            <li>
            <a href="#">
            <img class="contacts-list-img" src="dist/img/user3-
            ...
            <li>
            <a href="#">
            <img class="contacts-list-img" src="dist/img/user5-
...
<li>
<a href="#">
<img class="contacts-list-img" src="dist/img/user6-
...
<li>
<a href="#">
<img class="contacts-list-img" src="dist/img/user8-
...
<div class="tools">
    ...
    <small class="badge badge-secondary"><i class="far fa-
    clock"></i> 1 month</small>
    ...
    <div class="card-tools">
        ...
        <button type="button" class="btn btn-primary btn-sm" data-card-
        widget="collapse" title="Collapse">
...
<button type="button" class="btn bg-info btn-sm" data-card-
widget="collapse">
...
<div class="card-body">
<canvas class="chart" id="line-chart" style="min-height: 250px;
...
<button type="button" class="btn btn-success btn-sm dropdown-
toggle" data-toggle="dropdown" data-offset="-52">
...
<button type="button" class="btn btn-success btn-sm" data-card-
widget="collapse">
...
<script src="{{ asset('adminlte') }}/plugins/tempusdominus-bootstrap-
4/js/tempusdominus-bootstrap-4.min.js"></script>

<!-- Summernote -->

<script src="{{ asset('adminlte') }}/plugins/summernote/summernote-
bs4.min.js"></script>
